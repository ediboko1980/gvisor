...
// getRefForBroadcastOrLoopbackRLocked returns an endpoint where address is the
// broadcast address for an endpoint's network or an address in an endpoint's
