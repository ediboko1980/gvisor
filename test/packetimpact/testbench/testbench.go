...
var (
	...
	Native = false
	// InjectDevice is the device that testbench uses to inject traffic.
	InjectDevice = ""
	// DUTDevice is the device name on the DUT, individual tests can
...
func RegisterFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&InjectDevice, "inject_device", InjectDevice, "local device to inject traffic")
	fs.StringVar(&DUTDevice, "dut_device", DUTDevice, "local device on the DUT")
